...
/**
 * The Class TurningLineComponent draws the map, draws the turning line component of radar,
 * adds the ripples coming from the radar
 */
public class TurningLineComponent extends JComponent implements Runnable {
	...
	public TurningLineComponent() {
		...
		towerImage = Toolkit.getDefaultToolkit().getImage("img/tower.png");
	}
	...
	public void paint(Graphics g) {
		...
		g2.drawImage(towerImage, (int) TOWER_X - 22, (int) TOWER_Y - 24, this);
		drawCirclesRipple();
		drawLine(g2);
	}
