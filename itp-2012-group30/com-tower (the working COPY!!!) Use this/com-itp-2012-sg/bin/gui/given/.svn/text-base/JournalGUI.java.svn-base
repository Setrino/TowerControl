...
//import org.epfl.itp.message.Message;
...
public class JournalGUI extends JFrame implements ActionListener /* , Observer */{
	...
	private class CustomTableCellRenderer extends DefaultTableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,boolean hasFocus, int row, int column) {
			...
			if (val instanceof Integer) {
				...
				//cell.setBackground(Message.PRIORITY_BACKCOLOR[priority]);
				//cell.setForeground(Message.PRIORITY_FORECOLOR[priority]);
			}
	...
	/** TODO: Do not forget to add new events to the JournalGUI. */
